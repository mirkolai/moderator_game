...
class SimulationParameters(BaseModel):
    ...
    bias_gamma: float = Field(default=1.15, ge=0.0, le=5.0)
    bias_alpha: float = Field(default=1.0, ge=0.0, le=5.0)
    bias_beta: float = Field(default=0.85, ge=0.0, le=5.0)

    p_repost_base: float = Field(default=1.8, ge=0.0, le=5.0)
    p_repost_gamma: float = Field(default=1.35, ge=0.0, le=5.0)
    p_repost_alpha: float = Field(default=0.95, ge=0.0, le=5.0)
    p_repost_beta: float = Field(default=0.65, ge=0.0, le=5.0)

    influence_strength: float = Field(default=0.08, ge=0.0, le=1.0)

    p_add_edge: float = Field(default=0.30, ge=0.0, le=1.0)
    edge_addition_gamma_threshold: float = Field(default=0.35, ge=0.0, le=1.0)
    edge_addition_alpha_threshold: float = Field(default=0.65, ge=0.0, le=1.0)
    ...
    center_tolerance: float = Field(default=0.5, ge=0.0, le=0.5)
